        ...
        <div className="min-h-screen pb-20">
            ...
            <div className="bg-slate-900 text-white py-20 px-4">
                <div className="container mx-auto max-w-5xl text-center">
                    <div className="inline-flex items-center gap-2 bg-white/10 px-4 py-2 rounded-full mb-6 text-gold font-bold uppercase tracking-wider text-sm backdrop-blur-sm">
                        <MapPin className="w-4 h-4" />
                        <span>Serving {area.locationName}</span>
                    </div>
