...
export default function QuoteForm() {
    ...
    return (
        <div className="bg-white p-8 rounded-2xl shadow-xl border border-slate-100" onMouseEnter={handleInteraction}>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex justify-center transform scale-90 origin-left min-h-[78px]">
                    {loadRecaptcha ? (
                        <ReCAPTCHA
                            ref={recaptchaRef}
                        ...
                        <div className="w-[304px] h-[78px] bg-slate-50 border border-slate-100 rounded-md flex items-center justify-center text-slate-400 text-xs italic">
